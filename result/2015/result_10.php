...
<body id="hpb-template-03-05-01" class="hpb-layoutset-02">
  ...
  <!-- ここから編集可能 -->
  <h3 class="hpb-parts-hl-08 hpb-parts-hl-style">●2015年　10月　〜競技結果〜</h3>
  <!--
  ...
  <tbody>
    <tr>
    <td bgcolor="#CCFF99" style="font-size : 140%;" width="599"><b>●2015年10月12日(月)　第27回　出雲全日本選抜駅伝競走</b></td>
    </tr>
    <tr>
    <td width="599">
    <table border="1">
    ...
    <td align="center" style="font-size : 110%;text-align : center;"><pb>青学記録!!</pb></td>
    </tr>
    <tr>
    ...
    <td align="center" style="font-size : 110%;text-align : center;">18:10</td>
    ...
    <td align="center" style="font-size : 110%;text-align : center;">18:36</td>
    <td align="center" style="font-size : 110%;text-align : center;">2位</td>
    <td align="center" style="font-size : 110%;text-align : center;"></td>
    </tr>
    <tr>
    ...
    <td align="center" style="font-size : 110%;text-align : center;" colspan="2">2:09:05</td>
    <td align="center" style="font-size : 110%;text-align : center;"><pb>優勝</pb><br>
  ...
  <?php
    result_start(2015,10,3,"土","第4回世田谷長距離競技会","5000m","setagaya");
    result_schema();
      result_list("14組",1,"大杉　柊平",2,"14:59.52",24,"sb");
      result_list("15組",7,"貞永　隆佑",2,"14:27.39",1,"sb");
        result_list_sub("橋間　貴弥",1,"14:32.93",4,"");
        result_list_sub("小田　俊平",2,"14:33.97",5,"sb");
        result_list_sub("木村　光佑",1,"14:36.34",9,"pb");
        result_list_sub("伊藤　雅一",2,"14:47.38",18,"sb");
        result_list_sub("松田　岳大",1,"14:51.66",23,"");
        result_list_sub("小野塚　久弥",1,"15:28.91",43,"");
      result_list("18組",6,"池田　生成",3,"14:16.14",3,"pb");
        result_list_sub("桂川　直也",1,"14:23.78",9,"pb");
        result_list_sub("石川　優作",2,"14:28.48",15,"sb");
        result_list_sub("小野塚　隆珠",3,"14:31.55",19,"pb");
        result_list_sub("鈴木　悠日",3,"14:38.15",23,"sb");
